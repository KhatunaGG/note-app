...
import useManageNotes, { NewNoteType } from "../../../store/notes.store";
...
// const Notes = ({ noteParam }: NotePropsType) => {
//   const { accessToken } = useSignInStore();
//   const {
//     allNotes,
//     getNoteById,
...
//     setIsNotePage,
//     setIsSettingsPage,
//     setSelectedTag, // Add this if it exists
//     setFilterAllByTag, // Add this if it exists
//     // clearTagFilters, // Add this if it exists, or create similar function
//     isNotePage,
//   } = useUtilities();
//   const route = useRouter();
//   const { mounted, theme } = useMountedTheme();
...
//       if (setFilterAllByTag) setFilterAllByTag(false);
//     }
