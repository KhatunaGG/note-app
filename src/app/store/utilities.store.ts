...
// Replace the getFilteredNotesByTag function with this simple version:
...
//     // const isNoteDetails = /^\/note\/[a-zA-Z0-9]+$/.test(path);
//     set({
//       isTagsPage: isTags,
//       isArchivedPage: isArchive,
//       filterAllByTag: isTags,
...
//           // isNoteDetailsPage: isNoteDetails,
//     });
//     if (isTags) {
//       const parts = path.split("/");
//       const tagFromURL = parts[2] || null;
...
//   clearTagFilters: () => {
//     set({ selectedTags: null, filterAllByTag: false });
//   },
